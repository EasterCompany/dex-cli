...
var RequiredPackages = []Package{
	...
	{Name: "python3.14", Required: true, MinVersion: "3.14", InstallCommand: "sudo pacman -S --noconfirm python314 || sudo pacman -S --noconfirm python3.14 || sudo apt install -y python3.14", UpgradeCommand: "sudo pacman -Syu --noconfirm python314 || sudo pacman -Syu --noconfirm python3.14 || (sudo apt update && sudo apt upgrade -y python3.14)"},
	{Name: "python3.10", Required: true, MinVersion: "3.10", InstallCommand: "sudo pacman -S --noconfirm python310 || sudo pacman -S --noconfirm python3.10 || sudo apt install -y python3.10", UpgradeCommand: "sudo pacman -Syu --noconfirm python310 || sudo pacman -Syu --noconfirm python3.10 || (sudo apt update && sudo apt upgrade -y python3.10)"},
	...
	{Name: "ffmpeg", Required: true, MinVersion: "4.0", InstallCommand: "sudo pacman -S --noconfirm ffmpeg || sudo apt install -y ffmpeg", UpgradeCommand: "sudo pacman -Syu --noconfirm ffmpeg || (sudo apt update && sudo apt upgrade -y ffmpeg)"},
